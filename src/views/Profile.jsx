          ...
          <div className="bg-white rounded-lg p-6">
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-600">
                Miembro desde {user.createdAt.split("T")[0]}
              </p>
            </div>
            ...
            <div className="space-y-3 mt-6">
              ...
              <button
                ...
                className="w-full py-2.5 bg-blue-400 text-white rounded-lg hover:bg-blue-600"
              >
              ...
              {orders.length > 0 ? (
                orders.map((order) => (
                  <div
                    ...
                    key={order.idBookOrder}
                  >
                    <div>
                      <p className="font-medium">
                        Pedido ID: {order.idBookOrder}
                      </p>
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
              <div className="bg-white p-6 rounded-lg w-96">
                ...
                <button
                  ...
                  className="w-full mt-2 py-2 bg-gray-400 text-white rounded-lg"
                >
                  Cancelar
                </button>
              </div>
